    ...
    public class ProductsDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(
                "Data Source=localhost;Initial Catalog=ProductsDB;Persist Security Info=True;User ID=sa;Password=bellinadmin;MultipleActiveResultSets=true;TrustServerCertificate=true;");
        }
